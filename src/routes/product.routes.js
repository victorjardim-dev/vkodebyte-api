...
const multerType = require("../../createimage");
...
routes.post("/", multerType.uploadImage.single("url_image"), middleProducts.checkFields, productController.createNewProduct);

// Atualiza um produto pelo seu código
routes.put("/:id", multerType.uploadImage.single("url_image"), middleProducts.checkFields, productController.ctrl_updateProductByCode);
